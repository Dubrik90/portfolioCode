...
// @ts-ignore
import Portfolio from "../../file/AliakseiDubrouski.pdf";
        ...
        <motion.section
            ...
            <div className={sRemoteJob.__container}>
                ...
                <motion.div custom={2} variants={textAnimation} className={sRemoteJob.btn}>
                    <a href={Portfolio} download title="Download CV"> <FontAwesomeIcon className={sRemoteJob.icon} icon={faArrowDown}/> Download CV</a>
                </motion.div>
            </div>
        </motion.section>
    );
